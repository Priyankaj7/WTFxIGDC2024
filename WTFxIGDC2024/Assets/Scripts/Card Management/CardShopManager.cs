...
public class CardShopManager : MonoBehaviour
{
    ...
    private void GenerateCards()
    {
        ...
        for (int i = 0; i < 4; i++)
        {
            ...
            PosX += 100f;
            card.GetComponent<CardLocked>().SetupCardData(GameController.instance.GetRandomItemData());
    ...
    public async void SpawnNewCard(GameObject oldCard)
    {
        ...
        oldCard.GetComponent<CardLocked>().SetupCardData(GameController.instance.GetRandomItemData());
